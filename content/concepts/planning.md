...
# Planning and Scheduling: The Next Phase
...
In course discovery, an abstract course code like "MS-A0111" is useful—it helps you find the right course. But real planning requires **concrete instances**: "MS-A0111 in Autumn 2025."
...
A **SchedulePair** is an optimized combination of study groups for 2+ instances in a Plan.
...
Imagine two courses with overlapping study groups:

```
CS-A1110: Lecture
  Monday 10:00-12:00 (weeks 1-12)

MATH-A1020: Exercise H01
  Monday 11:00-13:00 (weeks 1-12)
```

A Decision Slot exists from 11:00-12:00 on Mondays. The student must choose:
...
## Phase 3: Full Calendar Views and Reflection
...
The project takes iterative steps. Some features exist as prototypes or design sketches; others are fully functional. We intentionally avoid committing to a rigid roadmap, preferring small testable steps over big promises.
...
**Next:** Explore how all these components fit together in our [architecture guide](../architecture/).
